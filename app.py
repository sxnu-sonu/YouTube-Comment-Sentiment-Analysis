# app_local.py - Flask app that loads models directly from files without MLflow/DagsHub
...
# Load the model and vectorizer directly from local files
...
def generate_trend_graph():
    try:
        ...
        # Save the trend graph to a BytesIO objectSS
        img_io = io.BytesIO()
